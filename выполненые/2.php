...
function valid($interval){
    ...
    $temp2=explode(":",$temp2);	
      ...
      if (intval($temp1[0])<0 or intval($temp1[0])>23){
    	  ...
    	  if (intval($temp1[1])<0 or intval($temp1[1])>59){
      ...
      /* проверяем часы второго интервала*/
      	if (intval($temp2[0])<0 or intval($temp2[0])>23){
    	  ...
    	  if (intval($temp2[1])<0 or intval($temp2[1])>59){
