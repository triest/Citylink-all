   ...
   // echo $home_number;echo  PHP_EOL;
    ...
    //теперь надо проверить, есть ли корпус через дефис
     ...
     //  echo "номер дома ";echo $home_number;
        ...
        //тут проверяем в каком регистре и приеудительно переводим в нижнийй
...
function low($str){
  $temp=strripos ("AБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ",$str);
